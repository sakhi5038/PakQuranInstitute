...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.gaurav.jitsi_meet_pro.JitsiMeetPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin jitsi_meet_pro, com.gaurav.jitsi_meet_pro.JitsiMeetPlugin", e);
    }
  }
}
